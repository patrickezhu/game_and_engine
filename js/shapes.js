...
class Simple3DRectangle { // has 1 constant axis
    ...
    render() {
        ...
        if (this.directional_vec[0] === 1 && this.directional_vec[1] === 0 && this.directional_vec[2] === 0) ctx.fillStyle = '#ff564a';
        if (this.directional_vec[0] === -1 && this.directional_vec[1] === 0 && this.directional_vec[2] === 0) ctx.fillStyle = '#870900';
        if (this.directional_vec[0] === 0 && this.directional_vec[1] === 1 && this.directional_vec[2] === 0) ctx.fillStyle = '#7dff7f';
        if (this.directional_vec[0] === 0 && this.directional_vec[1] === -1 && this.directional_vec[2] === 0) ctx.fillStyle = '#004d01';
        if (this.directional_vec[0] === 0 && this.directional_vec[1] === 0 && this.directional_vec[2] === 1) ctx.fillStyle = '#82c1ff';
        if (this.directional_vec[0] === 0 && this.directional_vec[1] === 0 && this.directional_vec[2] === -1) ctx.fillStyle = '#003263';
...
function drawSimpleRectangularPrism(aX, aY, aZ, bX, bY, bZ) {
